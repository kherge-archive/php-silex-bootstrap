...
return false;}};});})(jQuery,window);!function($){"use strict";$(function(){$.support.transition=(function(){var transitionEnd=(function(){var el=document.createElement('bootstrap'),transEndEventNames={'WebkitTransition':'webkitTransitionEnd','MozTransition':'transitionend','OTransition':'oTransitionEnd otransitionend','transition':'transitionend'},name
...
$spy.affix(data)})})}(window.jQuery);$(function(){"use strict";$('.input-add button').each(function(){$(this).click(function(){var list=$(this).parents("ul");var counter=list.data("counter");var template=list.data("prototype");var added=$("<li></li>");added.html(template.replace(/__name__/g,counter++));added.find("button").click(function(){$(this).parents("li").remove();});$(this).parent("li").before(added);list.data("counter",counter);});});});